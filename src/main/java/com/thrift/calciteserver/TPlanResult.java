...
public class TPlanResult implements org.apache.thrift.TBase<TPlanResult, TPlanResult._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanResult> {
  ...
  public java.lang.String plan_result; // required
  ...
  public TPlanResult setPlan_result(java.lang.String plan_result) {
    this.plan_result = plan_result;
    return this;
  }
  ...
  public int compareTo(TPlanResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPlan_result()).compareTo(other.isSetPlan_result());
    if (lastComparison != 0) {
